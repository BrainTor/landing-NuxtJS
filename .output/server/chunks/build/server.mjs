...
const _routes = [
  {
    name: "code",
    path: "/code",
    component: () => import('./code-C1vnERnU.mjs')
  },
  {
    name: "games-calc",
    path: "/games/calc",
    component: () => import('./calc-C_5cx08l.mjs')
  },
  {
    name: "games-cross",
    path: "/games/cross",
    component: () => import('./cross-CLxFrDg-.mjs')
  },
  {
    name: "games-find_tres",
    path: "/games/find_tres",
    component: () => import('./find_tres-BHUIcBAI.mjs')
  },
  {
    name: "games-ham",
    path: "/games/ham",
    component: () => import('./ham-y3KpRqto.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-E6DJMBv_.mjs')
  },
  {
    name: "study",
    path: "/study",
    component: () => import('./study-CiHguXVx.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BE6fvEI4.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Er3auSaO.mjs'));
